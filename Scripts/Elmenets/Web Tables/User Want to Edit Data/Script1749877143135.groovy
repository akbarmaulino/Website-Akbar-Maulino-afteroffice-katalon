...
WebUI.setText(findTestObject('Object Repository/ElementPage/Web Tables Page/field_Department'), GlobalVariable.EditDepartement)

WebUI.click(findTestObject('Object Repository/ElementPage/Web Tables Page/button_Submit'))

def dataMap = [('Departement') : GlobalVariable.EditDepartement]
...
dataMap.each({ def key, def expectedValue ->
        ...
        if (actualValue == expectedValue) {
            ...
            KeywordUtil.markPassed('Berhasil Melakukan Edit')
        } else {
